...
function redisEmployeeCreateTest() returns error? {
    ...
    db:Employee employeeRetrieved = check rainierClient->/employees/[employee1.empNo];
...
function redisEmployeeCreateTest2() returns error? {
    ...
    db:Employee employeeRetrieved = check rainierClient->/employees/[employee2.empNo];
...
function redisEmployeeReadOneTestNegative() returns error? {
    ...
    db:Employee|error employeeRetrieved = rainierClient->/employees/["invalid-employee-id"];
...
function redisEmployeeReadManyTest() returns error? {
    ...
    stream<db:Employee, persist:Error?> employeeStream = rainierClient->/employees;
    db:Employee[] employees = check from db:Employee employee in employeeStream
...
function redisEmployeeUpdateTest() returns error? {
    ...
    db:Employee employee = check rainierClient->/employees/[employee1.empNo].put({
...
function redisEmployeeUpdateTestNegative1() returns error? {
    ...
    db:Employee|error employee = rainierClient->/employees/["invalid-employee-id"].put({
        lastName: "Jones"
    });
...
function redisEmployeeUpdateTestNegative3() returns error? {
    ...
    db:Employee|error employee = rainierClient->/employees/[employee1.empNo].put({
...
function redisEmployeeDeleteTest() returns error? {
    ...
    db:Employee employee = check rainierClient->/employees/[employee1.empNo].delete();
    test:assertEquals(employee, updatedEmployee1);

    stream<db:Employee, error?> employeeStream = rainierClient->/employees;
    db:Employee[] employees = check from db:Employee employee2 in employeeStream
...
function redisEmployeeDeleteTestNegative() returns error? {
    ...
    db:Employee|error employee = rainierClient->/employees/[employee1.empNo].delete();
